document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".great-navigation-list");
  const headerRef = document.querySelector(".great-header");
  const navigationRef = document.querySelector(".great-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".great-toggle-button img");
